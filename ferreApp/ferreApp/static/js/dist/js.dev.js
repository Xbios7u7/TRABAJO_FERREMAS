...
window.addEventListener("resize", anchoPage); //Declarando variables

var formulario_login = document.querySelector(".formulario__login");
var formulario_register = document.querySelector(".formulario__register");
var contenedor_login_register = document.querySelector(".contenedor__login-register");
var caja_trasera_login = document.querySelector(".caja__trasera-login");
var caja_trasera_register = document.querySelector(".caja__trasera-register"); //FUNCIONES
...
function mostrarErrorContrasema() {
  ...
  var mensajeError = document.getElementById("mensaje-error-contraseña"); // Mostrar el mensaje de error
...
function verificarContraseña() {
  ...
  if (contraseñaIngresada !== contraseñaCorrecta) {
    console.log("Contraseña correcta "); // La contraseña es incorrecta, así que mostramos el mensaje de error

    mostrarErrorContraseña();
  } else {
    console.log("Contraseña incorrecta "); // La contraseña es correcta, puedes hacer algo aquí si lo necesitas
  }
}
